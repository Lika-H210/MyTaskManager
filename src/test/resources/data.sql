-- ユーザー
INSERT INTO user_accounts (public_id, user_name, email, password)
VALUES
...
VALUES
  ...
  (2, '33333333-cccc-dddd-eeee-1234567890ab', NULL,
   '画面モック作成', 'FigmaでUIの初期デザインを作成', '2025-08-05', 120, 60, 50, 'MEDIUM'),

  (2, '55555555-eeee-ffff-0000-1234567890ab', 3,
   'UIコンポーネントの設計', '共通UIコンポーネントのレイアウト設計を行う', '2025-08-06', 60, 60, 100, 'MEDIUM'),

  (2, '66666666-ffff-0000-1111-1234567890ab', 3,
   'フィードバック対応', 'レビュー結果を反映してUIを調整する', '2025-08-07', 60, 0, 0, 'LOW'),
